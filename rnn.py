...
class RNN(nn.Module):
    ...
    def forward(self, inputs):
        #  n [to fill] obtain hidden layer representation (https://pytorch.org/docs/stable/generated/torch.nn.RNN.html)
        outputs, hidden = self.rnn(inputs)
        
        # [to fill] obtain output layer representations
        output_representations = self.W(outputs)
        
        # [to fill] sum over output 
        summed_output = torch.sum(output_representations, dim=0)
